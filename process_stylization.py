...
def stylization(stylization_module, smoothing_module, cont_img, styl_img, content_seg_path, style_seg_path, cuda, save_intermediate, no_post, cont_seg_remapping=None, styl_seg_remapping=None):
    # Load image
    with torch.no_grad():
